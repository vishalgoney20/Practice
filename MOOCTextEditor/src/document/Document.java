...
public abstract class Document {
	...
	protected int countSyllables(String word)
	{
		...
		// eg : iterate on book for better understanding..... 
		int numSyllables = 0;
	...
	public double getFleschScore()
	{
		...
		double score;
		double noOfWords=(double)getNumWords();
		double noOfSentences=(double)getNumSentences();
		double noOfSyllables=(double)getNumSyllables();
		score=206.835-1.015*(noOfWords/noOfSentences)-84.6*(noOfSyllables/noOfWords);
		double finalValue = Math.round(score*100.0)/100.0;
	    return finalValue;
	}
